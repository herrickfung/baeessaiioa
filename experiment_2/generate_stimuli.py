...
def main():
    ...
    for i in range(No_of_Trials):
        ...
        age_array.append(show_info[5])
        gender_array.append(show_info[6])
        hand_array.append(show_info[7])
        ...
        # stimuli screen
        gabor(triallist[i][0], triallist[i][1], triallist[i][2])
        win.flip()
        win.getMovieFrame(buffer='front')
